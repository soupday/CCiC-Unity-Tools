    ...
    public class ImporterWindow : EditorWindow
    {
        ...
        */
        ...
        private void OnGUISettingsArea(Rect settingsBlock)
        {
            ...
            string[] options = new string[] { "Calculate Base and BlendShape Normals", "Calculate Base Normals, no BlendShape Normals", "Import Base Normals, no BlendShape Normals", "Import Base, Calculate BlendShape Normals (Bad results)", "Import Base and BlendShape Normals (Broken)" };
